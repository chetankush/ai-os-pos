...
export async function registerRoutes(app: FastifyInstance): Promise<void> {
  ...
  // Signup needs Supabase config but neither DB nor auth (it's the entry door).
  ...
  if (hasDb && hasAuth) {
    ...
    app.log.warn('owner routes not registered — requires DATABASE_URL and SUPABASE_JWT_SECRET');
  }
